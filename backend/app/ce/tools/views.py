...
class AutoBinarySearchManage(MABaseView):
    ...
    async def post_data(self, **kwargs):
        ...
        -----END PUBLIC KEY-----'''
        sign = Sign(param, serect, access_id)
        url = "https://xly.bce.baidu.com/open-api/ipipe/rest/v3/pipeline-builds?pipelineId=25264"
        # new_params = {
        #     "repo_name": "PaddleDetection",
        #     "model_name": "configs^tood^tood_r50_fpn_1x_coco",
        #     "step_name": "train",
        #     "email_add": "xiege01@baidu.com"
        # }
        new_params_json = json.dumps(kwargs)
        data = {
            "branch": "develop",
