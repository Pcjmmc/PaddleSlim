  ...
  <div style="margin-top:0.5%;">
    ...
    <Card>
        ...
        <Card>
          <Form :ref="'addForm' + index" :model="item" :rules="ruleCustom" :label-width="75">
            ...
            <Row>
              ...
              <Col span="8">
                <Form-item label="修复状态:" prop="status">
      ...
      <Row type="flex" justify="center">
        <Col span="3">
          <el-button type="primary" icon="plus-circled" size="medium" @click="saveData">保存</el-button>
        </Col>
      </Row>
    </Card>
  </div>
                ...
                <Col span="5">
                  <Form-item label="类型:" prop="type">
                    <el-radio-group v-model="item.type">
                      ...
                      <el-radio-button label="Delay"></el-radio-button>
                    </el-radio-group>
                  </Form-item>
                </Col>
              </Row>
